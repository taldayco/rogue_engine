...
void SpriteBatch::createVertexArray() {
  ...
  // tell openGL what kind of attributes we need
...
void SpriteBatch::sortGlyphs() {
  ...
  case GlyphSortType::TEXTURE:
    ...
    break;
  case GlyphSortType::NONE: // Handle the NONE case
    // Do nothing since there's no sorting required
    break;
  }
}

// Static comparison functions defined within the class
